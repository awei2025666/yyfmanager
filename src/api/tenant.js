...
export const getTenantOutsourceTenantsAll = (payload = {}) => tenantHttp.post('/api/tenant/tenant/all', payload)
...
export const getTenantTenantRoleList = () => tenantHttp.get('/api/tenant/tenantRole/list')
export const getTenantTenantRoleOptions = () => tenantHttp.get('/api/tenant/tenantRole/all')
export const addTenantTenantRole = (payload = {}) => tenantHttp.post('/api/tenant/tenantRole/add', payload)
export const editTenantTenantRole = (payload = {}) => tenantHttp.post('/api/tenant/tenantRole/edit', payload)
export const deleteTenantTenantRole = (id) => tenantHttp.get('/api/tenant/tenantRole/del', { params: { id } })
export const getTenantRoleMenus = () => tenantHttp.get('/api/tenant/tenantRole/menuAll')
export const getTenantRoleMenuById = (id) => tenantHttp.get('/api/tenant/tenantRole/roleMenu', { params: { id } })
export const updateTenantRoleMenus = (payload = {}) => tenantHttp.post('/api/tenant/tenantRole/roleMenuUpdate', payload)
