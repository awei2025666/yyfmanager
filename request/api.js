...
const api = {
	...
	followStatus: () => http('/api/user/wechat/followStatus', 'GET'),
	...
	selfDeptUser: (params) => http('/api/user/user/selfDeptUser', 'POST', params),
	...
	productInfo: (params) => http('/api/user/order/productInfo', 'GET', params),
	...
	orderFile: (params) => http('/api/user/order/file', 'GET', params),
	...
	startProduction: (params) => http('/api/user/order/startProduction', 'GET', params),
	completeProduction: (params) => http('/api/user/order/completeProduction', 'POST', params),
	packInfo: (params) => http('/api/user/order/packInfo', 'GET', params),
	pack: (params) => http('/api/user/order/pack', 'POST', params),
